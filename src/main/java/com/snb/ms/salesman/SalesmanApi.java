...
public interface SalesmanApi {
  ...
  @ApiResponses({
    @ApiResponse(
        ...
        content =
            @Content(
                array = @ArraySchema(schema = @Schema(implementation = SalesmanResponse.class)))),
    @ApiResponse(
        responseCode = "500",
  ...
  @Operation(
      ...
      description =
          "Creates a salesman and links the record with one or more companies and internal user profile.")
  @CommonApiParameters
  @RequestBody(
      required = true,
  ...
  @ApiResponses({
    @ApiResponse(responseCode = "204", description = "Salesman soft-deleted successfully"),
    @ApiResponse(
        responseCode = "404",
        description = "Salesman not found",
        content =
