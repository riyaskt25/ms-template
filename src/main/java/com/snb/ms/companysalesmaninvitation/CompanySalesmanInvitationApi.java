...
@Tag(
    name = "[009] - Company Salesman Invitations",
    description = "Operations for inviting salesmen to register under a company")
public interface CompanySalesmanInvitationApi {
  ...
  @Operation(
      ...
      description =
          "Creates invitation records for one or more companies and allows the invited salesman to register later in the system.")
  @CommonApiParameters
  @RequestBody(
      required = true,
        ...
        content =
            @Content(
                array =
                    @ArraySchema(
                        schema =
                            @Schema(implementation = CompanySalesmanInvitationResponse.class)))),
    @ApiResponse(
        responseCode = "400",
        description =
            "Validation failed or an open invitation already exists for the same invitee details",
        content =
            @Content(
  ...
  ResponseEntity<List<CompanySalesmanInvitationResponse>> create(
