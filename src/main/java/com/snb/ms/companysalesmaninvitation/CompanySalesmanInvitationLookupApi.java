...
public interface CompanySalesmanInvitationLookupApi {
  ...
  @Operation(
      ...
      description =
          "Returns all company invitation records that match the supplied email address, including the related company details.")
  @CommonApiParameters
  @Parameters({
    @Parameter(
        name = "email",
  ...
  @ApiResponses({
    @ApiResponse(
        ...
        content =
            @Content(
                schema = @Schema(implementation = CompanySalesmanInvitationListResponse.class))),
    @ApiResponse(
        responseCode = "400",
