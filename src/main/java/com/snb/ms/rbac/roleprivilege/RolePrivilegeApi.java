...
public interface RolePrivilegeApi {
    ...
    @ApiResponses({
        @ApiResponse(responseCode = "200", description = "Role privileges fetched successfully",
            content = @Content(schema = @Schema(implementation = RolePrivilegesAggregateResponse.class))),
        @ApiResponse(responseCode = "404", description = "Role not found",
            content = @Content(schema = @Schema(implementation = BaseResponseDTO.class),
                examples = @ExampleObject(name = "GetPrivilegesByRoleCodeNotFoundError",
    ...
    @ApiResponses({
        @ApiResponse(responseCode = "200", description = "Privilege granted successfully",
            content = @Content(schema = @Schema(implementation = RolePrivilegesAggregateResponse.class))),
        @ApiResponse(responseCode = "400", description = "Validation failed",
            content = @Content(schema = @Schema(implementation = BaseResponseDTO.class),
                examples = @ExampleObject(name = "GrantPrivilegeToRoleValidationError",
                    value = "{\n  \"errors\": [\n    {\n      \"type\": \"VALIDATION_ERROR\",\n      \"code\": \"PRIVILEGECODE_REQUIRED\",\n      \"message\": \"privilegeCode is required\",\n      \"description\": \"Field 'privilegeCode' must not be blank\"\n    }\n  ]\n}"))),
        @ApiResponse(responseCode = "409", description = "Privilege already granted",
            content = @Content(schema = @Schema(implementation = BaseResponseDTO.class),
    ...
    ResponseEntity<RolePrivilegesAggregateResponse> grant(String roleCode, @Valid RolePrivilegeRequest request);

    @Operation(operationId = "grantPrivilegesToRoleBulk", summary = "Grant privileges to role in bulk", description = "Creates multiple role-privilege grants in one request. Operation is all-or-nothing.")
    @CommonApiParameters
    @Parameters({@Parameter(name = "roleCode", description = "Role code", required = true, example = "SUPER_ADMIN")})
    ...
    @ApiResponses({
        @ApiResponse(responseCode = "200", description = "Privileges granted successfully",
            content = @Content(schema = @Schema(implementation = RolePrivilegesAggregateResponse.class))),
        @ApiResponse(responseCode = "400", description = "Validation failed",
            content = @Content(schema = @Schema(implementation = BaseResponseDTO.class),
        ...
        @ApiResponse(responseCode = "409", description = "One or more privileges are already granted",
            content = @Content(schema = @Schema(implementation = BaseResponseDTO.class),
                examples = @ExampleObject(name = "RolePrivilegeBulkConflictError",
                    value = "{\n  \"errors\": [\n    {\n      \"type\": \"CONFLICT\",\n      \"code\": \"CONFLICT\",\n      \"message\": \"Conflict\",\n      \"description\": \"Role already has this privilege granted\"\n    }\n  ]\n}"))),
        @ApiResponse(responseCode = "404", description = "Role or privilege not found",
            content = @Content(schema = @Schema(implementation = BaseResponseDTO.class),
    ...
    ResponseEntity<RolePrivilegesAggregateResponse> grantBulk(String roleCode, @Valid RolePrivilegeBulkRequest request);
