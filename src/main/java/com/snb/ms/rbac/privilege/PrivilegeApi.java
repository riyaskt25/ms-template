...
public interface PrivilegeApi {
  ...
  @Operation(
      ...
      description = "Returns all active privilege records.")
  @CommonApiParameters
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
        ...
        content =
            @Content(
                array = @ArraySchema(schema = @Schema(implementation = PrivilegeResponse.class)))),
    @ApiResponse(
        responseCode = "500",
        ...
        content =
            @Content(
                ...
                examples =
                    @ExampleObject(
                        name = "GetAllPrivilegesInternalError",
                        value =
  ...
  @Operation(
      operationId = "getPrivilegeByCode",
      summary = "Get privilege by code",
      description = "Finds a privilege by code.")
  @CommonApiParameters
  @Parameters({
    @Parameter(
        name = "privilegeCode",
  ...
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
        description = "Privilege fetched successfully",
        content = @Content(schema = @Schema(implementation = PrivilegeResponse.class))),
    @ApiResponse(
        responseCode = "400",
        description = "Invalid privilege code supplied",
        content =
            @Content(
                schema = @Schema(implementation = BaseResponseDTO.class),
                examples =
                    @ExampleObject(
                        name = "GetPrivilegeByCodeValidationError",
                        value =
    ...
    @ApiResponse(
        ...
        content =
            @Content(
                ...
                examples =
                    @ExampleObject(
                        name = "GetPrivilegeByCodeNotFoundError",
                        value =
    ...
    @ApiResponse(
        ...
        content =
            @Content(
                ...
                examples =
                    @ExampleObject(
                        name = "GetPrivilegeByCodeInternalError",
                        value =
