...
public interface RoleApi {
  ...
  @Operation(
      ...
      summary = "List roles",
      description = "Returns all active role records.")
  @CommonApiParameters
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
        ...
        content =
            @Content(array = @ArraySchema(schema = @Schema(implementation = RoleResponse.class)))),
    @ApiResponse(
        responseCode = "500",
  ...
  @Operation(
      ...
      description = "Finds a role by code.")
  @CommonApiParameters
  @Parameters({
    @Parameter(
        name = "roleCode",
  ...
  @ApiResponses({
    ...
    @ApiResponse(
        responseCode = "400",
        description = "Invalid role code supplied",
    ...
    @ApiResponse(
        ...
        content =
            @Content(
                ...
                examples =
                    @ExampleObject(
                        name = "GetRoleByCodeNotFoundError",
                        value =
    ...
    @ApiResponse(
        ...
        content =
            @Content(
                ...
                examples =
                    @ExampleObject(
                        name = "GetRoleByCodeInternalError",
                        value =
  ...
  @RequestBody(
      required = true,
      description = "Role payload to create",
      content =
          @Content(
              schema = @Schema(implementation = RoleCreateRequest.class),
              examples =
                  @ExampleObject(
                      name = "CreateRoleRequestExample",
                      value =
  ...
  @Operation(
      operationId = "createRolesBulk",
      summary = "Create roles in bulk",
      description = "Creates multiple role records in a single request.")
  @CommonApiParameters
  @RequestBody(
      required = true,
      description = "Bulk role payload to create",
      content =
          @Content(
              schema = @Schema(implementation = RoleBulkCreateRequest.class),
              examples =
                  @ExampleObject(
                      name = "CreateRolesBulkRequestExample",
                      value =
    ...
    @ApiResponse(
        ...
        content =
            @Content(
                ...
                examples =
                    @ExampleObject(
                        name = "CreateRolesBulkValidationError",
                        value =
    ...
    @ApiResponse(
        ...
        content =
            @Content(
                ...
                examples =
                    @ExampleObject(
                        name = "CreateRolesBulkInternalError",
                        value =
  ...
  @Operation(
      ...
      summary = "Update role",
      description = "Updates an existing role record by code.")
  @CommonApiParameters
  @Parameters({
    @Parameter(
        name = "roleCode",
  ...
  @RequestBody(
      required = true,
      description = "Role payload to update",
      content =
          @Content(
              schema = @Schema(implementation = RoleUpdateRequest.class),
              examples =
                  @ExampleObject(
                      name = "UpdateRoleRequestExample",
                      value =
  ...
  @Operation(
      ...
      summary = "Delete role",
      description = "Soft-deletes a role record by code.")
  @CommonApiParameters
  @Parameters({
    @Parameter(
        name = "roleCode",
