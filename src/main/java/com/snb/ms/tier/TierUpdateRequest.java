...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Tier update request payload")
public class TierUpdateRequest {
  ...
  @Schema(description = "Display order", example = "2", requiredMode = Schema.RequiredMode.REQUIRED)
