...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Admin user creation request payload")
public class AdminUserCreateRequest {
    ...
    @Schema(description = "Middle name", example = "M", maxLength = 100, requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "Extension number", example = "EXT-1001", maxLength = 20, requiredMode = Schema.RequiredMode.REQUIRED)
    private String extensionNumber;

    @NotBlank(message = "{validation.adminUser.snbId.required}")
    @Size(max = 50, message = "{validation.adminUser.snbId.size}")
    @Schema(description = "Organization employee identifier", example = "SNB1001", maxLength = 50, requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "Admin user mobile number", example = "+971555010301", maxLength = 20, requiredMode = Schema.RequiredMode.REQUIRED)
