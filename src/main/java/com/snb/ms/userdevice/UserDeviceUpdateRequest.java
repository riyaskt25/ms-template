...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "User device update request payload")
public class UserDeviceUpdateRequest {
  ...
  @Schema(description = "Device model", example = "iPhone 15", maxLength = 100)
  private String deviceModel;

  @Size(max = 50, message = "{validation.userDevice.osVersion.size}")
  @Schema(description = "Operating system version", example = "17.5", maxLength = 50)
  private String osVersion;

  @Size(max = 50, message = "{validation.userDevice.appVersion.size}")
  @Schema(description = "Application version", example = "1.0.1", maxLength = 50)
  private String appVersion;

  @Size(max = 500, message = "{validation.userDevice.pushToken.size}")
  @Schema(
      description = "Push notification token",
      example = "push-token-value-updated",
      maxLength = 500)
  private String pushToken;

  @Schema(description = "Push token updated at", example = "2026-06-02T10:15:30")
  ...
  @Schema(description = "Failed login attempts", example = "1")
  private Integer failedAttempts;

  @Size(max = 100, message = "{validation.userDevice.deviceName.size}")
  @Schema(description = "Device friendly name", example = "John's iPhone", maxLength = 100)
